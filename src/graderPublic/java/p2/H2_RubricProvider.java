...
public class H2_RubricProvider implements RubricProvider {
    ...
    Criterion H1_1 = createUntestedCriterion("Die Methode read funktioniert korrekt, wenn der Wurzelknoten keine Kinder hat.");

    Criterion H1_2 = createUntestedCriterion("Die Methode read funktioniert korrekt, wenn nur alle Intervalle komplett gelesen werden.");

    Criterion H1_3 = createUntestedCriterion("Die Methode read funktioniert korrekt, wenn das Start interval nur zum Teil gelesen wird.");

    Criterion H1_4 = createUntestedCriterion("Die Methode read funktioniert korrekt, wenn das start und end Intervall nur zum Teil gelesen wird.");

    Criterion H1 = createParentCriterion("1", "Aus Dateien lesen", H1_1, H1_2, H1_3, H1_4);

    Criterion H2_1_1 = createCriterion("Die Methode split funktioniert splittet den Knoten in normalen Fällen korrekt.",
        () -> SplitTests.class.getDeclaredMethod("testSimpleSplit", List.class, int.class, int.class, int.class, List.class));

    Criterion H2_1_2 = createCriterion("Die Methode split aktualisiert die Werte in der übergebenen IndexedNodeLinkedList korrekt.",
    ...
    Criterion H2_1_3 = createCriterion("Die Methode split funktioniert korrekt, wenn der Wurzelknoten gesplittet wird.",
        () -> SplitTests.class.getDeclaredMethod("testSplitRoot", List.class, int.class, int.class, int.class, int.class, List.class));

    Criterion H2_1_4 = createCriterion("Die Methode funktioniert zusätzlich korrekt, wenn rekursive mehrere Knoten gesplittet werden müssen.",
        () -> SplitTests.class.getDeclaredMethod("testSimpleSplit", List.class, int.class, int.class, int.class, List.class),
        () -> SplitTests.class.getDeclaredMethod("testIndexedNodeLinkedList", List.class, int.class, int.class, int.class, int.class, int.class),
        () -> SplitTests.class.getDeclaredMethod("testSplitRoot", List.class, int.class, int.class, int.class, int.class, List.class),
    ...
    Criterion H2_2_2 = createCriterion("Die Methode findInsertionPosition funktioniert zusätzlich korrekt, wenn der Wurzelknoten Kinder hat und kein Intervall aufgeteilt werden muss.",
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testNoChildNoSplitting", List.class, int.class, int.class, int.class, List.class),
    ...
    Criterion H2_2_3 = createCriterion("Die Methode findInsertionPosition funktioniert zusätzlich korrekt, wenn Intervalle aufgeteilt werden müssen, aber der Blattknoten nicht voll ist.",
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testNoChildNoSplitting", List.class, int.class, int.class, int.class, List.class),
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testWithChildNoSplitting", List.class, int.class, int.class, int.class, List.class),
    ...
    Criterion H2_2_4 = createCriterion("Die Methode findInsertionPosition funktioniert zusätzlich korrekt, wenn Intervalle aufgeteilt werden müssen und der Blattknoten voll ist.",
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testNoChildNoSplitting", List.class, int.class, int.class, int.class, List.class),
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testWithChildNoSplitting", List.class, int.class, int.class, int.class, List.class),
        () -> FindInsertionPositionTests.class.getDeclaredMethod("testWithKeySplitting", List.class, int.class, int.class, int.class, List.class, List.class),
